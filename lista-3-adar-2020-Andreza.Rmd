...
```{r}
cab <- c("DJF", "JFM", "FMA", "MAM", "AMJ", "MJJ", "JJA", "JAS", "ASO", "tipo_modleo", "modelo")
...
# as.numeric(unlist(prev_enos_jan2021))
# lapply(prev_enos_jan2021, as.numeric)
